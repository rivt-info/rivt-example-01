...
.. header::
    .. list-table::
        ...
        * - **Example 1 - rivt Doc** - v1.0.0a11 |s| |s| |s| |s| Sect: **###Section###**
          - p. **###Page###**   
...
.. code-block:: text 
           ...
           —————          —————       —————               —————      —————
           partitions DL  plywood DL  fixed machinery DL  joists DL  beam spacing
           —————————————  ——————————  ——————————————————  —————————  ————————————
...
.. code-block:: text 
           ...
           —————                  —————                        —————                        —————
           modulus of elasticity  rectangle - I (sectprop.py)  Total load [ASCE7-05 2.3.2]  beam span
           —————————————————————  ———————————————————————————  ———————————————————————————  —————————
