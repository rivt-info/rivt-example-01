...
.. code-block:: text 
           ...
           D₁         D₃             spc₁          D₂          D₄
           —————————  —————————————  ————————————  ——————————  ——————————————————
           3.80 psf   10.00 psf      2.00 ft       2.10 psf    3.00 klf
           joists DL  partitions DL  beam spacing  plywood DL  fixed machinery DL
           —————————  —————————————  ————————————  ——————————  ——————————————————
...
.. code-block:: text 
  ...
  spn_1     omega_1    inertia_1      E_1
  ————————  —————————  —————————————  ————————————
  16.00 ft  3.77 klf   4860.00 inch4  29000.00 ksi
  ————————  —————————  —————————————  ————————————
